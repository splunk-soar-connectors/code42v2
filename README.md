...
This table lists the configuration variables required to operate Code42 v2. These variables are specified when configuring a Code42 v2 asset in Splunk SOAR.
