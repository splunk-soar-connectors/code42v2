...
class TestCode42DetectionListsConnector(object):
    ...
    def test_handle_action_when_add_departing_employee_and_is_successful_sets_success_status(
        ...
        assert msg == f"test@example.com was added to the departing employees list"
    ...
    def test_handle_action_when_remove_departing_employee_and_is_successful_sets_success_status(
        ...
        assert len(action_results) == 1
        msg = action_results[0].get_message()
        assert msg == "test@example.com was removed from the departing employees list"
    ...
    def test_handle_action_when_add_high_risk_employee_and_is_successful_sets_success_status(
        ...
        assert len(action_results) == 1
        msg = action_results[0].get_message()
        assert msg == "test@example.com was added to the high risk employees list"
    ...
    def test_handle_action_when_remove_departing_employee_and_is_successful_sets_success_status(
        ...
        assert len(action_results) == 1
        msg = action_results[0].get_message()
        assert msg == f"test@example.com was removed from the departing employees list"
