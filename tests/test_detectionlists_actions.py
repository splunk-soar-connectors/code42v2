...
class TestCode42DetectionListsConnector(object):
    ...
    def test_handle_action_when_add_departing_employee_adds_user_info_to_summary(
    ...
    def test_handle_action_when_remove_departing_employee_adds_user_info_to_summary(
        self, mocker, mock_py42_with_user, mock_result_adder
    ):
        param = {"username": "test@example.com"}
        result = ActionResult(dict(param))
